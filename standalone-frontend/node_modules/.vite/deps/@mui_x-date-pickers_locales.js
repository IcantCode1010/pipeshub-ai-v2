...
var caESPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, adapter) => `Selecciona ${views2[view]}. ${time === null ? "Hora no seleccionada" : `L'hora seleccionada és ${adapter.format(time, "fullTime")}`}`,
...
var daDKPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, adapter) => `Vælg ${timeViews2[view] ?? view}. ${time === null ? "Intet tidspunkt valgt" : `Valgte tidspunkt er ${adapter.format(time, "fullTime")}`}`,
...
var deDEPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, adapter) => `${timeViews3[view] ?? view} auswählen. ${time === null ? "Keine Uhrzeit ausgewählt" : `Gewählte Uhrzeit ist ${adapter.format(time, "fullTime")}`}`,
...
var huHUPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, adapter) => `${timeViews5[view] ?? view} kiválasztása. ${time === null ? "Nincs kiválasztva idő" : `A kiválasztott idő ${adapter.format(time, "fullTime")}`}`,
  ...
  day: "Nap",
  weekDay: "Hétköznap",
  hours: timeViews5.hours,
  minutes: timeViews5.minutes,
  seconds: timeViews5.seconds,
  meridiem: timeViews5.meridiem,
  // Common
  empty: "Üres"
};
...
var jaJPPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, adapter) => `${timeViews7[view] ?? view}を選択してください ${time === null ? "時間が選択されていません" : `選択した時間は ${adapter.format(time, "fullTime")} です`}`,
...
var nnNOPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, adapter) => `Vel ${timeViews11[view]}. ${time === null ? "Ingen tid vald" : `Vald tid er ${adapter.format(time, "fullTime")}`}`,
  ...
  // Digital clock labels
  selectViewText: (view) => `Vel ${timeViews11[view]}`,
  // Calendar labels
...
var roROPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, adapter) => `Selectați ${timeViews14[view] ?? view}. ${time === null ? "Nicio oră selectată" : `Ora selectată este ${adapter.format(time, "fullTime")}`}`,
...
var skSKPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, adapter) => `${timeViews16[view] ?? view} vybraný. ${time === null ? "Nie je vybraný čas" : `Vybraný čas je ${adapter.format(time, "fullTime")}`}`,
