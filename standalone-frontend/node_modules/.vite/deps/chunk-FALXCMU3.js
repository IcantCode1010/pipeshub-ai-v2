...
var Autocomplete = React2.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index) => {
        ...
        return (0, import_jsx_runtime.jsx)(Chip_default, _extends({
  ...
  const defaultRenderOption = (props2, option) => {
    ...
    return (0, import_jsx_runtime.jsx)("li", _extends({}, otherProps, {
...
//# sourceMappingURL=chunk-FALXCMU3.js.map
